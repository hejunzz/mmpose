...
data_cfg = dict(
    ...
    oks_thr=0.9,
    vis_thr=0.2,
    use_gt_bbox=True, # bbox using ground truth
    det_bbox_thr=0.0,
    bbox_file='/data2/diwgan32/coco/person_detection_results/'
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/annotations/person_wholebody_keypoints_train2017.json',
    ...
    val=dict(
        type='TopDownCocoWholeBodyDataset',
        ann_file=f'{data_root}/annotations/person_wholebody_keypoints_val2017.json',
